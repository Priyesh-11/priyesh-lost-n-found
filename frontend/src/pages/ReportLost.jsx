...
const ReportLost = () => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        if (cats && cats.length > 0) {
          // Map API categories to the format expected by the Select component if needed
          // Assuming API returns { id, name, ... } and we need { value, label }
  ...
  const getCategoryId = (value) => {
    ...
    return category ? category.id : 9; // Default to 'other' (ID 9) or handle error
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const itemData = {
        ...
        date_lost: new Date(formData.date).toISOString(), // Backend expects ISO string
      ...
      toast({
        ...
        description: 'Your lost item has been posted. We\'ll notify you if someone finds it.'
      });
      navigate('/dashboard');
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Fill in the details about your lost item</p>
        </div>
